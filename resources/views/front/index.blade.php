...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/front/styles/styles.css')}}">
...
<body class="main-content">
    <header class="section sec1 header active" id="home">
        <div class="header-content">
            <div class="left-header">
                ...
                <div class="image">
                    <img src="{{asset('public/front/img/hero.png')}}" alt="">
                </div>
            </div>
    ...
    <main>
        ...
        <section class="section sec3" id="portfolio">
            ...
            <div class="portfolios">
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port1.jpg')}}" alt="">
                    </div>
                ...
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port2.jpg')}}" alt="">
                    </div>
                    <div class="hover-items">
                        <h3>Project Source</h3>
                        <div class="icons">
                ...
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port3.jpg')}}" alt="">
                    </div>
                    <div class="hover-items">
                        <h3>Project Source</h3>
                        <div class="icons">
                ...
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port4.jpg')}}" alt="">
                    </div>
                    <div class="hover-items">
                        <h3>Project Source</h3>
                        <div class="icons">
                ...
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port5.jpg')}}" alt="">
                    </div>
                    <div class="hover-items">
                        <h3>Project Source</h3>
                        <div class="icons">
                ...
                <div class="portfolio-item">
                    <div class="image">
                        <img src="{{asset('public/front/img/port7.jpg')}}" alt="">
                    </div>
                    <div class="hover-items">
                        <h3>Project Source</h3>
                        <div class="icons">
        ...
        <section class="section sec4 " id="blogs">
            <div class="blogs-content">
                ...
                <div class="blogs">
                    <div class="blog">
                        <img src="{{asset('public/front/img/port6.jpg')}}" alt="">
                        <div class="blog-text">
                            <h4>
                    ...
                    <div class="blog">
                        <img src="{{asset('public/front/img/blog1.jpg')}}" alt="">
                        <div class="blog-text">
                            <h4>
                    ...
                    <div class="blog">
                        <img src="{{asset('public/front/img/blog2.jpg')}}" alt="">
                        <div class="blog-text">
                            <h4>
                    ...
                    <div class="blog">
                        <img src="{{asset('public/front/img/blog3.jpg')}}" alt="">
                        <div class="blog-text">
                            <h4>
    ...
    <script src="{{asset('public/front/app.js')}}"></script>
</body>
</html>
